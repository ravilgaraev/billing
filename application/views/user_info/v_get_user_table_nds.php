...
<?php if('Y' == $user[0]['unlim']): ?>
    <tr>
        ...
        <td class="text-right"><?php echo ('n' == $user[0]['nds'])?"Без НДС":$stavkands;//echo number_format($stavkands,2,'.',',');?></td>
...
<?php if($user[0]['plan'] > 0 ): ?>
    <tr>
        ...
        <td class="text-right">
            <?php echo ('n' == $user[0]['nds'])?"Без НДС":$stavkands;//echo number_format($stavkands,2,'.',',');?>
        </td>
        <td class="text-right">
...
<?php if ((0 < $traffic_in_pr)&&($traffic_in_pr > $traffic_out_pr))
        {
            ...
            echo "<td class=\"text-right\">",
                    $user[0]['price_out'],
                 "</td>";
            echo "<td class=\"text-right\">",$stavkands,"</td>";
            echo "<td class=\"text-right\">", $stavkands,"%";
...
<?php if ((0 < $traffic_out_pr)&&($traffic_out_pr > $traffic_in_pr))
        {
            echo "<tr>";
            echo "<td>Превышение исходящего трафика</td>";
            echo "<td>Mbyte</td>";
            ...
            echo "<td class=\"text-right\">",$stavkands,"%","</td>";
            echo "<td class=\"text-right\">",$stavkands,"%";
                //number_format($price_out_pr*$stavkands/100,2,'.',',');
            echo "</td>";
            echo "<td class=\"text-right\">";
