        ...
        <table style="width: 100%" class=" table table-print">
            ...
            <tr> 
                <td class="text-center" colspan="10">
                    <?php
                        switch ($user[0]['paymentmethod']) {
                            case 'Usd': $sum = Model::factory('sumpropis')->num2stren($many);break;
                            case 'Euro':$sum = Model::factory('sumpropis')->num2strer($many);break;
                            default:    $sum = Model::factory('sumpropis')->num2str($many);break;
                        }
...
//                        }
//                        list($sum[0], $sum[0]) = mb_strtoupper($sum[0].$sum[1], 'UTF8');  
//                        echo $sum,", including VAT ",number_format($many - $many*100/($stavkands+100),2,'.',',');
//                    ?>
